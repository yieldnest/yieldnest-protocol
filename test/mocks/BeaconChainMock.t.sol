...
import "lib/eigenlayer-contracts/src/contracts/libraries/BeaconChainProofs.sol";
import "lib/eigenlayer-contracts/src/contracts/libraries/Merkle.sol";
import "lib/eigenlayer-contracts/src/contracts/pods/EigenPodManager.sol";

import "lib/eigenlayer-contracts/src/test/integration/mocks/EIP_4788_Oracle_Mock.t.sol";
import "lib/eigenlayer-contracts/src/test/integration/utils/PrintUtils.t.sol";
...
contract BeaconChainMock is PrintUtils {
    ...
    *******************************************************************************/
    ...
    function _getValidatorLeaves() internal view returns (bytes32[] memory) {
        ...
        for (uint i = 0; i < validators.length; i++) {
            leaves[i] = Merkle.merkleizeSha256(
                _getValidatorFields(uint40(i))
            );
        }
