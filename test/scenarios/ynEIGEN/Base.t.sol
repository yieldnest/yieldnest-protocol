...
// TODO Same as https://github.com/yieldnest/yieldnest-protocol/blob/851fa22da16b4a150c6735907036bc68aa928f82/test/scenarios/fork/ynETH/Base.t.sol
...
contract Base is Test, Utils {
    ...
    function setUp() public virtual {
        ...
        for(uint256 i = 0; i < stakingNodesManager.nodesLength(); i++) {
            ...
            //TODO stakingNodesManager.nodes(i).syncQueuedShares();
            vm.stopPrank();
        }
